...
REPO="${DOCKERMGRREPO:-https://github.com/$SCRIPTS_PREFIX}/couchdb"
APPVERSION="$(__appversion "$REPO/raw/$REPO_BRANCH/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="couchdb"
export INSTDIR="$HOME/.local/share/CasjaysDev/$SCRIPTS_PREFIX/couchdb"
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default: [couchdb.$SET_HOST_FULL_NAME] [$SET_HOST_FULL_DOMAIN]
CONTAINER_HOSTNAME=""
