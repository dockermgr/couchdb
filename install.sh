...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202210082240-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  WTFPL
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Saturday, Oct 08, 2022 22:40 EDT
# @@File             :  install.sh
# @@Description      :  
...
# Defaults variables
APPNAME="couchdb"
INSTDIR="$HOME/.local/share/dockermgr/couchdb"
APPDIR="$HOME/.local/share/srv/docker/couchdb"
DATADIR="$HOME/.local/share/srv/docker/couchdb/files"
...
HUB_URL="casjaysdevdocker/couchdb:latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
if [ -z "$HUB_URL" ] || [ "$HUB_URL" = "hello-world" ] || echo "$HUB_URL" | grep -q "couchdb"; then
