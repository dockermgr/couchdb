...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/couchdb"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="couchdb"
export APPDIR="$HOME/.local/share/srv/docker/couchdb"
export DATADIR="$HOME/.local/share/srv/docker/couchdb/rootfs"
export INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/couchdb"
...
HUB_IMAGE_URL="casjaysdevdocker/couchdb"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# image tag [docker pull HUB_IMAGE_URL:tag]
HUB_IMAGE_TAG="latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set the container name Default: [casjaysdevdocker/couchdb-$HUB_IMAGE_TAG]
CONTAINER_NAME=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default: couchdb
CONTAINER_HOSTNAME=""
...
CONTAINER_SERVICES_LIST="couchdb"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
if [ -z "$CONTAINER_NAME" ]; then
  CONTAINER_NAME="$(__container_name || echo "casjaysdevdocker/couchdb-$HUB_IMAGE_TAG")"
fi
...
if [ -n "$COUCHDB_USERNAME" ]; then
  CONTAINER_USER_NAME="$COUCHDB_USERNAME"
fi
if [ -n "$CONTAINER_USER_NAME" ]; then
  CONTAINER_USER_NAME="${COUCHDB_USERNAME:-${CONTAINER_USER_NAME:-$DEFAULT_USERNAME}}"
fi
if [ -n "$CONTAINER_USER_NAME" ]; then
